...
task main()
{
	...
	while(encoder<6000)//FYRIR FIMMTUDAG DESEMBER: nota encoder til ad leidbeina snuninga
	{
		...
		{
			motor[leftMotor]  = speed*1.5;
			motor[rightMotor] = speed*1.5;
		}
		else{
			if (nav == "R"){
					motor[leftMotor] = speed;
		...
		//-*--*-verk 6 kodi eftir dessa linu-*--*-eda ekki//
